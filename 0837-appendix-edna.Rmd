...
The interactive Peace eDNA map shows site-level detection results with toggleable per-species layers and an opt-in Controls layer for field blanks. See the `r ngr::ngr_str_link_url(url_base = params$report_url, url_resource = "edna_unbc_results_2025_peace_map.html", anchor_text = "interactive Peace eDNA map")`.
