...
COST ESTIMATEs AND CORRECT BCFISHPASS HABITAT SHOULD WORK ONCE THIS IS FIXED https://github.com/NewGraphEnvironment/fish_passage_template_reporting/issues/142
...
PSCIS crossing `r as.character(my_site)` was first assessed with a fish passage assessment as part of this project in 2024 and ranked as a barrier to fish passage with medium value habitat documented [@irvine_schick2025RestoringFish]. The crossing was reassessed in 2025 and a habitat confirmation assessment was conducted due to the presence of medium value habitat and a significant outlet drop at the culvert. 
