...
Since the time of field assessements this crossing was deactivated by BC Timber Sales. 
...
The habitat upstream of PSCIS crossing `r as.character(my_site)` on `r fpr_my_pscis_info(col_pull = road_name, site = my_site)` was documented as medium value for salmonid spawning and rearing, and the crossing was rated as a `r fpr_my_pscis_info(col_pull = my_priority, site = my_site)` for deactivation.
