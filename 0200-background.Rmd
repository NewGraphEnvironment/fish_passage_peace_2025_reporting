...
```{r overview-map, fig.cap = paste0('Overview map of the study area, showing fish passage assessment and restoration progress to date. The mapped extent reflects where field work has been concentrated; connectivity modelling covers all ', length(params$wsg_code), ' watershed groups of the FWCP Peace Region, as set out in the scales of work table above. Future versions will render the full regional extent so the modelled and field-assessed areas are visible together.'), eval=T}
