...
This appendix lists the UAV (drone) imagery products generated for the Peace project area since `r params$project_start_year` and stored as Cloud Optimized GeoTIFFs on AWS. Each row links to a tile-service viewer for in-browser inspection alongside a direct download link to the source raster.
